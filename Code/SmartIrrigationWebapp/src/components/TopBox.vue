  ...
  <v-card class="grey lighten-5 border" style="border-radius: 0px; border: none;">
    <v-card-text class="topBox border" :class="{'chosen': chosen}" style="padding: 0px">
      ...
      <v-layout row wrap class="border" style="padding: 0px">
        <v-flex xs6 class="border display-1 text-xs-left pt-1 pl-3" style="height: 45px">
        ...
        <v-flex xs6>
          <v-layout row wrap>
            <v-flex xs4 v-for="i in 2" class="pl-0 border icon" :key="i">
            </v-flex>
            <v-flex xs4 class="pl-0 border icon">
            ...
            <transition name="slide-fade">
              <v-flex xs4 class="pl-0 icon" @click.stop="editName" v-show="chosen">
                <v-icon>edit</v-icon>
              </v-flex>
            </transition>
          </v-layout row wrap>
